...
```{r, echo=TRUE}
expenses <- c("Food", "Electricity", "Savings", "Other Miscellaneous Expense")
percentage <- c(60, 10, 5, 25)
expensee2 <- data.frame(expenses,percentage)
...
piechart <- pie( percentage_expenses, labels = data2, 
            cex = 0.8, col = rainbow(4), main = "De Jesus family Monthly Expenses")
...
yfit <- yfit*diff(hhh$mids[1:2])*length(x)
